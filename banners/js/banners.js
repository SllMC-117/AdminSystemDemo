...
let idBanner; //Esencial para BTN Acciones
...
console.log('ESTAMOS EN BANNERS JS');
...
data.accion = 'getBanners';

pintadoBanners(data); //Inicializamos función Pintado Maniobras y pasamos data

//Función Pintado de BANNERS
function pintadoBanners(data) {
    //Llamamos funcion peticion(data)
    global.peticion(data).then(function (res) {
        //Función Pintado de BANNERS

        //Vistas
        let mainBanners = res.mainBanners; //Vista principal

        //Agregamos vista principal a contenedor de Sección inicial
        $('#containerSection').html(mainBanners);
